...
- PK already exists guard will be performed when adding a new entity and throw a 309 conflict via a new conflict exception if a record already exists with that guid. -- fixes #29
