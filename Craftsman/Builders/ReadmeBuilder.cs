...
3. Confirm that you have migrations in your infrastructure project. If not you can add them by doing the following:
    ...
    2. Run a Migration (necessary to set up the database) `dotnet ef migrations add ""InitialMigration"" --project {solutionName}.Infrastructure --startup-project {solutionName}.WebApi --output-dir Migrations`
