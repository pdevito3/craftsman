namespace Craftsman.Removers
{
    ...
    public class TestFakesRemover
    {
        ...
        {
            var classPath = ClassPathHelper.TestFakesClassPath(solutionDirectory, $"", entityName, template.SolutionName); // deleting directory, so I don't need to give a meaningful filename
